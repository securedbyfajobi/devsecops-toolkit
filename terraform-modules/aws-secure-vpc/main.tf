# Secure AWS VPC Terraform Module
# Creates a hardened VPC with security best practices
...
resource "aws_network_acl" "main" {
  ...
  # Allow SSH from specific CIDR (if provided)
  dynamic "ingress" {
...
resource "aws_cloudwatch_log_group" "vpc_flow_log" {
  ...
  name              = "/aws/vpc/flowlog/${var.name_prefix}"
